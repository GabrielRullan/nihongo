...
PROMPT_CONCEPTS = {
    ...
    "茶": "a beautiful pastel teacup with steaming hot tea, a tiny green tea leaf floating on top, and a friendly smiley face on the cup",
    "水": "a cute pastel glass of refreshing water with small ice cubes, a friendly smiley face on the glass, and tiny bubbles, with a little pink straw",
